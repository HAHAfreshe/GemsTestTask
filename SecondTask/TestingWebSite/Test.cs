...
namespace TestingWebSite
{
    ...
    public class Test
    {
        ...
        {
            driver.Navigate().GoToUrl("https://gemsdev.ru/geometa/");
            string exp = driver.FindElement(By.XPath("//section[@class='gos-system bg_circle']/div/div/div[@class='col-12 col-md-6 mb-5 mb-md-0 wow fadeInUp']/a")).GetAttribute("href");
